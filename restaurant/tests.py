...
class HomePageTests(TestCase):
    ...
    def test_home_page_contains_requested_denizli_address_and_map(self):
        ...
        self.assertContains(response, "data-map-src=")
        self.assertContains(response, "data-map-load")
        self.assertNotContains(response, ' src="https://www.google.com/maps')
    ...
    def test_hero_highlights_the_turkish_flag_responsively(self):
        ...
        self.assertContains(response, "turk-bayragi-kumas-192.webp")
        self.assertContains(response, "turk-bayragi-kumas-384.webp")
        self.assertContains(response, 'sizes="(max-width: 48rem) 7.75rem, 12rem"')
